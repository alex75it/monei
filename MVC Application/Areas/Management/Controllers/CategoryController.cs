    ...
    public class CategoryController : MoneiControllerBase
    {
        ...
        public ActionResult Edit(string id)
        {
            ...
            try
            {
                ...
                Category category = categoryManager.Read(categoryId);
        ...
        public ActionResult Edit(Category category, FormCollection collection)
        {
            ...
            try
            {
                ...
                Account currentAccount = GetAccount();
                category.LastChangeDate = DateTime.UtcNow;
                category.LastUpdateAccount = currentAccount;
